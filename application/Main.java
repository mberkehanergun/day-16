            ...
            loginButton.setOnAction(event -> {
                ...
                if (loginFail == false && ifNotExit == true) {
                    ...
                    companySettingsButton.setOnAction(companySettingsEvent -> {
                        ...
                        settingsLayout.getChildren().addAll(resultLabel, createTableButton1, dropTableButton1, createTableButton2, dropTableButton2, createTableButton3, dropTableButton3, backButtonToButtonScene1);
